## 3MLIDTS-EmmanuelSalinas-03Python
...
def guardar_valores():
    ...
    if not nombres.isalpha():
        messagebox.showerror("Error", "El campo 'Nombres' debe contener solo letras.")
        return
    
    if not apellidos.isalpha():
        messagebox.showerror("Error", "El campo 'Apellidos' debe contener solo letras.")
        return
    
    if not telefono.isdigit():
        messagebox.showerror("Error", "El campo 'Telefono' debe contener solo numeros.")
        return
